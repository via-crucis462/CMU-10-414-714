...
def xavier_uniform(fan_in, fan_out, gain=1.0, **kwargs):
    ### BEGIN YOUR SOLUTION
    bound = gain * ((6 / (fan_out + fan_in)) ** 0.5)
...
def xavier_normal(fan_in, fan_out, gain=1.0, **kwargs):
    ### BEGIN YOUR SOLUTION
    extstd = gain * ((2/(fan_in + fan_out)) ** 0.5)
    return randn(fan_in , fan_out , std = extstd , **kwargs)
    ### END YOUR SOLUTION
...
def kaiming_uniform(fan_in, fan_out, nonlinearity="relu", **kwargs):
    ...
    ### BEGIN YOUR SOLUTION
    extbound = (2 ** 0.5) * ((3/fan_in) ** 0.5)
    return rand(fan_in , fan_out , low = -extbound , high = extbound , **kwargs)
    ### END YOUR SOLUTION
